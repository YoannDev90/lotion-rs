    ...
    fn stress_test_app_state_serialization() {
        ...
        for w in 0..100 {
            ...
            for t in 0..10 {
                ...
                app_state.tabs.insert(tab_id.clone(), crate::state::TabState {
                    id: tab_id.clone(),
                    title: format!("Tab {}", t),
            ...
            app_state.windows.insert(window_id.clone(), crate::state::WindowState {
                id: window_id,
                bounds: crate::state::Bounds { x: Some(0.0), y: Some(0.0), width: 800.0, height: 600.0 },
                is_focused: false,
                is_maximized: false,
                is_minimized: false,
        ...
        let decoded: AppState = serde_json::from_str(&json).expect("Failed to deserialize large state");
