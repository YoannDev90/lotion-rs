...
- **Email**: [YoannDev90@users.noreply.github.com](mailto:YoannDev90@users.noreply.github.com)
- **GitHub Private Vulnerability Reporting**: Use the "Report a vulnerability" button on the [repository's Security tab](https://github.com/YoannDev90/lotion-rs/security/advisories/new) (preferred).
